...
|---|---|---|---|---|
| Servidor de impresión portátil | diseño | cualquiera se lo puede llevar | física | Confidencialidad |
| Documentos y planos sobre las mesas | uso | una persona no autorizada puede leerlos o fotografiarlos | física | Confidencialidad |
| Ordenadores portátiles sin medidas de seguridad visibles | uso | robo del equipo o acceso no autorizado | física | Confidencialidad |
| Cables de los ordenadores accesibles | implementación | desconexión, manipulación o sabotaje | física | Disponibilidad |
| Equipos informáticos accesibles al personal | diseño | manipulación por una persona no autorizada | física | Integridad |
| Planos y documentación en estanterías sin protección | uso | acceso o sustracción por una persona no autorizada | física | Confidencialidad |
| Ventanas accesibles desde el exterior | diseño | entrada de personas no autorizadas | física | Confidencialidad, Integridad y Disponibilidad |
